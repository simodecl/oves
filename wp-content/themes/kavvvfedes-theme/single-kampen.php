...
?>      <div class="sportkampHead">  
        ...
        <div style="max-width:100vw;overflow:hidden;"><img style="margin:-9% 0 0 -10px;width:103%;" src="<?php bloginfo('template_url'); ?>/assets/waves/KAVVV_greendark_180.svg" /></div>
